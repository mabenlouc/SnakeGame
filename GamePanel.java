...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void draw(Graphics g) {
        ...
        if (running) {
            ...
            g.drawString("Score: " + orangesEaten, (SCREEN_WIDTH - metrics.stringWidth("Score: " + orangesEaten)) / 2,
                    g.getFont().getSize());
    ...
    public void gameOver(Graphics g) {
        ...
        g.drawString("Score: " + orangesEaten, (SCREEN_WIDTH - metrics1.stringWidth("Score: " + orangesEaten)) / 2,
                g.getFont().getSize());
